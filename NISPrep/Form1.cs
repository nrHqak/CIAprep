    ...
    public class Form1 : Form
    {
        ...
        private void BuildSubjectScreen()
        {
            ...
            for (int i = 0; i < subjects.Length; i++)
            {
                ...
                btn.Click += (s, e) => StartTest(subjects[i]);
        ...
        private void BuildTestScreen()
        {
            ...
            nextButton = CreateButton("Далее", new Rectangle(30, 390, 150, 46), false);
            finishButton = CreateButton("Завершить тест", new Rectangle(190, 390, 190, 46), true);
            var toHome = CreateButton("К предметам", new Rectangle(390, 390, 170, 46), true);
        ...
        private void LoadQuestion()
        {
            ...
            for (int i = 0; i < options.Length; i++)
            {
                ...
                options[i].Checked = answers.Count > currentIndex && answers[currentIndex] == i;
            }
        ...
        private void SaveCurrentAnswer()
        {
            ...
            if (answers.Count > currentIndex) answers[currentIndex] = selected;
            else answers.Add(selected);
        }
        ...
        private void FinishTest()
        {
            ...
            int correct = 0;
            for (int i = 0; i < answers.Count && i < currentQuestions.Count; i++)
            {
